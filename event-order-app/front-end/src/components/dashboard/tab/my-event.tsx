...
const MyEventsTab = () => {
  ...
  return (
    <div className="flex-1 min-h-screen bg-stone-100 sm:px-4 md:px-6 lg:px-8 py-8 ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8 gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 sm:px-5 py-2 mt-6 bg-slate-700 text-white rounded-xl shadow hover:bg-slate-800 transition w-full sm:w-auto justify-center"
          >
